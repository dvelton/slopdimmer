...
- **Pattern matching** against ~480 regex patterns covering preamble phrases, empty hedging, stakes inflation, vacuous conclusions, performative flattery, model-specific phrasing, meeting-speak, marketing copy, PR review filler, chat filler, documentation filler, hedging words, patronizing analogies, false profundity, copula avoidance ("serves as" replacing "is"), significance/legacy inflation, promotional puffery, blog transition filler, social media rhetoric, buzzwords, conference-talk filler, overattribution, temporal clichés, assertion dodges, and more. These patterns also match against ~455 filler phrase embeddings via cosine similarity, using a bundled sentence-transformer model (all-MiniLM-L6-v2).
